...
server.tool('get_screen', 'Lấy trạng thái màn hình hiện tại của thiết bị Android dưới dạng JSON.', {}, () => executeCommandAsTool(`python3 ${utilsPath('get_screen.py')}`));
server.tool('execute_action', 'Thực hiện một hành động trên thiết bị Android.', {
...
server.tool('check_env', 'Kiểm tra môi trường ADB và kết nối thiết bị Android.', {}, () => executeCommandAsTool(`python3 ${utilsPath('check_env.py')}`));
